        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-blue-100">
              Lorem ipsum dolor sit amet consectetur. Nunc quis dolor tempor lacinia nunc. Tincidunt vulputate sed amet elit. Habitant tortor nibh egestas qu
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-blue-100">123 Finance Street Douala, Cameroon</p>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 flex-shrink-0" />
                <a href="tel:+237123456789" className="text-blue-100 hover:text-white transition-colors">
                  +237 123 456 789
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <a href="mailto:info@creditmatch.com" className="text-blue-100 hover:text-white transition-colors">
